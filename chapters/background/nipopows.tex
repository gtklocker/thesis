...
Seeing that proofs are linear in the chain length, it is normal to ask if we can do better. NIPoPoW \cite{nipopows} provides the first family of succinct proofs which are logarithmic in the size of the chain and proven secure in the Backbone \cite{backbone} protocol.
